...
import time
unique_terms = {}
#UNIPROT_FILE_LOCATION ="all_ec_neg_set16th.faa" # "XML_FILES/swiss-prot_all_eukaryotic2.xml"#"swiss-prot_all_eukaryotic.xml"
...
#UNIPROT_FILE_LOCATION = "laccase_positive_set_PT_5-20.xml"  
#"expanded_laccase_positive_set.xml"
#"laccase_like_positive_set.xml"#"all_ec_numbers.xml"
...
for event,elem in ET.iterparse(UNIPROT_FILE_LOCATION,events=("start","end")):
    ...
    if elem.tag == "{http://uniprot.org/uniprot}entry" and event == "end":
        ...
        print(">"+accession_number+"["+fullName+"@name"+",".join(ecnumber_list)+"]"+"\n"+fasta_seq)
