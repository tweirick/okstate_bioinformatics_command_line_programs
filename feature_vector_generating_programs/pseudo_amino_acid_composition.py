...
def splitaminoacidcomposition(fasta_entry,start_counting_from=1):
    """
...
#dipeptide_dict = builddipeptidedict()
#Test length   
#print(len(dipeptide_dict))
#Test Composition
#print(dipeptide_dict)
#file_name = "test_fasta.faa"
#set_type = "0"
#output_file_name = "test_output_vector.stv"
